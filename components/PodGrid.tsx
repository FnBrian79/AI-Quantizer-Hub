        ...
        <div className="bg-[#141414] px-3 py-2.5 flex flex-col gap-2 shrink-0 border-b border-black">
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-1 items-center">
               <button className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500" aria-label="Previous page"><ChevronLeft size={16} /></button>
               <button className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500" aria-label="Next page"><ChevronRightIcon size={16} /></button>
               <button className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500 mr-1" aria-label="Reload content"><RotateCw size={14} className={isRunning ? "text-blue-500" : ""} /></button>
            ...
            <div className="flex gap-1">
              <button 
                ...
                aria-label="Toggle local AR layer"
              >
                <Layers size={16} />
              </button>
