        ...
        <div className="bg-[#141414] px-3 py-2.5 flex flex-col gap-2 shrink-0 border-b border-black">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 flex items-center gap-1 overflow-hidden">
               ...
               <button aria-label="New tab" className="p-1 hover:bg-slate-800 rounded-md cursor-pointer border-none bg-transparent">
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-1 items-center">
               <button aria-label="Go back" className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500"><ChevronLeft size={16} /></button>
               <button aria-label="Go forward" className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500"><ChevronRightIcon size={16} /></button>
               <button aria-label="Reload" className="p-1.5 hover:bg-slate-800 rounded-md text-slate-500 mr-1"><RotateCw size={14} className={isRunning ? "text-blue-500" : ""} /></button>
