...
import { Play, Square, RefreshCcw, Send, Settings2, Zap } from 'lucide-react';
      ...
      <div className="mt-5 p-3 bg-slate-950 rounded-xl border border-slate-800">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-transparent border-none outline-none text-[10px] text-blue-400 font-mono placeholder:text-slate-700"
          />
          <button
